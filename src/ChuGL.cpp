...
CK_DLL_QUERY(ChuGL)
{
    ...
    // set info
    QUERY->setinfo( CHUGIN_INFO_AUTHORS, "Andrew Zhu Aday & Ge Wang" );
    QUERY->setinfo( CHUGIN_INFO_CHUGIN_VERSION, CHUGL_VERSION_STRING );
    QUERY->setinfo( CHUGIN_INFO_DESCRIPTION, "ChuGL (ChucK Graphics Library) is a unified audiovisual programming framework built into the ChucK programming language." );
    QUERY->setinfo( CHUGIN_INFO_URL, "https://chuck.stanford.edu/chugl/" );
