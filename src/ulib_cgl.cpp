...
CK_DLL_DTOR(cgl_texture_dtor)
{
	CGL::PushCommand(new DestroySceneGraphNodeCommand(SELF, texture_data_offset, &CGL::mainScene));
}
...
{
	CGL::PushCommand(new DestroySceneGraphNodeCommand(SELF, cglmat_data_offset, &CGL::mainScene));
}
...
CK_DLL_DTOR(cgl_obj_dtor)
{
	CGL::PushCommand(new DestroySceneGraphNodeCommand(SELF, ggen_data_offset, &CGL::mainScene));
}
